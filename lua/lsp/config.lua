...
M.config = function(client, bufnr)
  ...
  local on_attach = function(client, bufnr)
    ...
    keymap("n", "<leader>lh", vlsp.hover, opts)
    keymap("n", "<leader>li", vlsp.implementation, opts)
    keymap("n", "<leader>ln", vlsp.rename, opts)
    keymap("n", "<leader>ls", vlsp.signature_help, opts)
    keymap("n", "<leader>lt", vlsp.type_definition, opts)
    keymap("n", "<leader>lr", vlsp.references, opts)
