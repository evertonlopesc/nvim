...
vim.keymap.set('n', '<leader>le', ':lua vim.lsp.buf.references()<CR>', {})
...
vim.keymap.set('n', '<leader>ll', ':lua vim.diagnostic.setloclist()<CR>', {})
vim.keymap.set('n', ']f', ':lua vim.diagnostic.show()<CR>', {})
vim.keymap.set('n', '<leader>lr', ':lua vim.lsp.buf.rename()<CR>', {})
vim.keymap.set('n', '<leader>lw', ':lua vim.lsp.buf.add_workspace_folder()<CR>', {})
vim.keymap.set('n', '<leader>lwr', ':lua vim.lsp.buf.remove_workspace_folder()<CR>', {})
vim.keymap.set('n', '<leader>ls', ':lua vim.lsp.buf.signature_help()<CR>', {})
vim.keymap.set('n', '<leader>ltd', ':lua vim.lsp.buf.type_definition()<CR>', {})
